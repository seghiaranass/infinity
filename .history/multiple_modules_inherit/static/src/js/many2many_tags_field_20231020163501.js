odoo.define('multiple_modules_inherit.many2many_tags_field',function(require){
const {_t } = require("web.core")
const { useService } = require("@web/core/utils/hooks");
const { Many2ManyTagsFieldColorEditable } = require("@web/views/fields/many2many_tags/many2many_tags_field");
...
console.log("Model: ", this.props.list.model);
